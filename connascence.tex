...
\begin{frame}
  ...
  \pdfbookmark[2]{Webster's Dictionary}{definitionwebsters}
  \frametitle{connascence definition by Webster's dictionary}
  \begin{enumerate}
    \item The common birth of two or more at the same time; production of two or more together.
...
\begin{frame}
  \pdfbookmark[2]{Jim Weirich}{definitionweirich}
...
\begin{frame}[fragile]
  \pdfbookmark[1]{transformation examples}{transformation}
  \pdfbookmark[2]{CoM to CoN}{comtocon}
...
\begin{frame}[fragile]
  \pdfbookmark[2]{CoE to CoP}{coetocop}
